...
ISDSL = -isystem sdsl-lite/include -L sdsl-lite/lib -lsdsl

INCLUDE = -I ./include

SDSL_INCLUDE = sdsl-lite/include/sdsl/

SDSL_A = sdsl-lite/lib/libsdsl.a

RRR_TIMER = sdsl_hacks/rrr_time_and_space.cpp sdsl-lite/lib/libsdsl.a
