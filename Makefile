...
SDSL_24_32_OP: rrr_time_and_space.cpp
	g++ $(CFLAGS) $(PF) -DBLOCK_SIZE=24 -o SDSL_24_32_OP rrr_time_and_space.cpp $(ISDSL)
...
SDSL_64_32_OP: rrr_time_and_space.cpp
	g++ $(CFLAGS) $(PF) -DBLOCK_SIZE=64 -o SDSL_64_32_OP rrr_time_and_space.cpp $(ISDSL)

H0R_64_32_OP: h0_bv.hpp internal.hpp  rrr_time_and_space.cpp 
	g++ $(CFLAGS) $(PF) -DBLOCK_SIZE=64 -DHACK='"h0_bv.hpp"' -DCLASSNAME='h0::h0_bv<>' -o H0R_64_32_OP rrr_time_and_space.cpp $(ISDSL)

H0I_63_32_OP: h0_63.hpp internal.hpp  rrr_time_and_space.cpp 
	g++ $(CFLAGS) $(PF) -DBLOCK_SIZE=63 -DHACK='"h0_63.hpp"' -DCLASSNAME='h0::h0_bv<>' -o H0I_63_32_OP rrr_time_and_space.cpp $(ISDSL)

H0I_64_32_OP: h0_it.hpp internal.hpp  rrr_time_and_space.cpp 
...
SDSL_24_32: rrr_time_and_space.cpp
	g++ $(CFLAGS) $(PF) -DRRR_NO_OPT -DBLOCK_SIZE=24 -o SDSL_24_32 rrr_time_and_space.cpp $(ISDSL)
...
SDSL_64_32: rrr_time_and_space.cpp
	g++ $(CFLAGS) $(PF) -DRRR_NO_OPT -DBLOCK_SIZE=64 -o SDSL_64_32 rrr_time_and_space.cpp $(ISDSL)
...
bins: SDSL_15_32_OP SDSL_24_32_OP SDSL_31_32_OP SDSL_63_32_OP SDSL_64_32_OP H0R_64_32_OP H0I_63_32_OP H0I_64_32_OP SDSL_24_32 SDSL_15_32 SDSL_31_32 SDSL_63_32 SDSL_64_32 H0R_64_32 H0I_63_32 H0I_64_32 RRR_15_32 H0GAP_15_32_15 H0GAP_15_32_24 H0GAP_15_32_32 H0GAP_15_32_64 H0GAP_24_32_15 H0GAP_24_32_24 H0GAP_24_32_32 H0GAP_24_32_64 H0WDBS_15_32 H0WDBS_24_32 HYBSDSL_256_32 HYBIT_256_32 HYBRRR_256_32

clean:
	cp -f hyb_vanilla.hpp $(SDSL_INCLUDE)hyb_vector.hpp
	rm -r res
	rm -f poke wdb_poke sdsl_comp SDSL_15_32_OP SDSL_24_32_OP SDSL_31_32_OP SDSL_63_32_OP SDSL_64_32_OP H0R_64_32_OP H0I_63_32_OP H0I_64_32_OP SDSL_24_32 SDSL_15_32 SDSL_31_32 SDSL_63_32 SDSL_64_32 H0R_64_32 H0I_63_32 H0I_64_32 RRR_15_32 H0GAP_15_32_15 H0GAP_15_32_24 H0GAP_15_32_32 H0GAP_15_32_64 H0GAP_24_32_15 H0GAP_24_32_24 H0GAP_24_32_32 H0GAP_24_32_64 H0WDBS_15_32 H0WDBS_24_32 HYBSDSL_256_32 HYBIT_256_32 HYBRRR_256_32
