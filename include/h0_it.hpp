...
class mults {
 public:
  ...
  static const constexpr std::array<std::array<uint64_t, 9>, n + 1> f_lim64 =
      f_lims_it<64>();
...
class h0_bv {
 ...
 public:
  ...
  uint64_t lookup_tables() const {
    uint64_t ret =
        sizeof(internal::mults::b64) + sizeof(internal::mults::b56) +
        ...
        sizeof(internal::mults::f_lim64) + sizeof(internal::mults::f_lim56) +
        sizeof(internal::mults::f_lim48) + sizeof(internal::mults::f_lim40) +
        sizeof(internal::mults::f_lim32) + sizeof(internal::mults::f_lim24) +
