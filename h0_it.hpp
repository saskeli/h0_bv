...
class mults {
   private:
    ...
    static const constexpr std::array<std::array<uint64_t, 8>, n + 1>
        f_lim64 = f_lims_it<64>();
    static const constexpr std::array<std::array<uint64_t, 8>, n - 8 + 1>
        f_lim56 = f_lims_it<56>();
    static const constexpr std::array<std::array<uint64_t, 8>, n - 16 + 1>
        f_lim48 = f_lims_it<48>();
    static const constexpr std::array<std::array<uint64_t, 8>, n - 24 + 1>
        f_lim40 = f_lims_it<40>();
    static const constexpr std::array<std::array<uint64_t, 8>, n - 32 + 1>
        f_lim32 = f_lims_it<32>();
    static const constexpr std::array<std::array<uint64_t, 8>, n - 40 + 1>
        f_lim24 = f_lims_it<24>();
    static const constexpr std::array<std::array<uint64_t, 8>, n - 48 + 1>
